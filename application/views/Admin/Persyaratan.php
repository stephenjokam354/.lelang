<div class="main-panel">
        ...
        <div class="row">
          <div class="col-md-12 stretch-card">
              <div class="card">
                  <div class="card-body">
                      <h1 class="admin-header mb-5 mt-3">Persyaratan User</h1>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document" style="border: none;">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer" style="border-top: 0 none;">
                                            ...
                                            <input type="submit" class="btn btn-danger" name="noValid" id="simpanBarang" value="Tidak Valid">
                                            <input type="submit" class="btn btn-success" name="Valid" id="simpanBarang" value="Valid">
                                        </div>
                                        </form>
                                    </div>
                                </div>
