          ...
          <div class="card-body">
            ...
            <?php if ($barang) {
              foreach ($barang as $brg) :
                ...
                <?php } else if ($brg['status_ktp'] == 2) { ?>
                  <label class="badge badge-danger">Tidak Valid</label>
                <?php } else if ($brg['status_ktp'] == 3) { ?>
            ...
            <?php if ($barang) {
              foreach ($barang as $brg) :
            ?>
                <img src="<?= base_url('assets/images/ktp/' . $brg['ktp']) ?>" style="max-width: 400px;">
              <?php endforeach;
            } else { ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="border: none;">
    <div class="modal-content">
      ...
      <div class="modal-body p-4">
        <form id="formBarang" action="<?= site_url('User/Master/Persyaratan/Ktp/insert') ?>" method="POST" enctype="multipart/form-data">

          <div class="form-group">
            <label for="txtNoKtp">Upload KTP</label>
